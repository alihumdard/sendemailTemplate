                    ...
                    <tr>
                        <td>
                            <p>Transfer Address Or Collection Point:<br>
                                ...
                                Registration number: CBDU457511 <br><br>
                                Data to be processed? <span class="checkboxs">
                            <label for="check11">Yes <input type="checkbox" id="check11"></label>
                            </span> <span class="checkboxs">
                            <label for="check12">No <input type="checkbox" id="check12"></label>
                            </span> <br><br>Data Destruction Method (If required):<br>
                            
  
  <div class="d-flex"><label for="vehicle1"> Data Wipe HMG level 1 </label><input type="checkbox" class="cb" id="level1" name="level1" value="l1"></div>
  <div class="d-flex"><label for="vehicle2"> Data Wipe HMG level 3 </label><input type="checkbox" class="cb" id="level3" name="level3" value="l3"></div>
  <div class="d-flex"><label for="vehicle3"> Crush (Charges May Apply) </label><input type="checkbox" class="cb" id="xtracharges" name="xtracharges" value="xtra"></div>
